         ...
         for(var i=0; i <compensationInputElements.length; i++){
   		...
   		if (regionCheckedValue.length == 0 && durationCheckedValue == 0 && costCheckedValue == 0 && compensationCheckedValue == 0 && programCheckedValue == 0){
   			...
   			for (var i = 0; i <pathways.programs.length; i++){
   				html += "<li class=\"resultsstyle\">"+
                     "<h3 class=\"resultsstyle\"><a class=\"resultsstyle\" href='" + pathways.programs[i].website + "' target=\"_blank\">"
                     + pathways.programs[i].program_name + "</a></h3>" +
                     "<h4>" + pathways.programs[i].program_type_wordy +", " + pathways.programs[i].location + "</h4>" +
                     "<h5> Cost/Compensation: " + pathways.programs[i].costcomp + "</h5>" +
                     "Description: <p class=\"resultsstyle\">" + pathways.programs[i].content + "</p></li>"
   			}
   		...
   		if(html == "<ul class=\"resultsstyle\"></ul>"){html += "No programs currently match your specifications."}
